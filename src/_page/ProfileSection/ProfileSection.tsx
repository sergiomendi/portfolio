...
import { commonSectionSx } from "../../page";

export function ProfileSection() {
  const githubUrl = "https://github.com/sergiomendi";
  const mailto = "smendiolaarraez@gmail.com";
  return (
    <Box sx={commonSectionSx}>
      <Box
        sx={{
          display: "flex",
      ...
      >
        <Box display={"flex"} flexDirection={"column"} gap={3}>
          ...
          <Typography variant="h3">
            ...
            using modern technologies. I love coding, travelling and learning
            new things!
          </Typography>
